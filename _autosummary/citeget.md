...
* **Return type:**
  [`ValidationResult`](citeget.validate.md#citeget.validate.ValidationResult)
...
* **Parameters:**
  * **ref** ([`Reference`](citeget.acquire_references.md#citeget.acquire_references.Reference)) – The reference to acquire.
...
* **Return type:**
  [`AcquisitionResult`](citeget.acquire_references.md#citeget.acquire_references.AcquisitionResult)
...
* **Return type:**
  [`Extractor`](citeget.extract.md#citeget.extract.Extractor)
...
* **Return type:**
  [`UrlResolver`](citeget.resolve.md#citeget.resolve.UrlResolver)
...
* **Return type:**
  [`AcquisitionStrategy`](citeget.resolve.md#citeget.resolve.AcquisitionStrategy)
...
* **Parameters:**
  ...
  * **extractor** ([`Extractor`](citeget.extract.md#citeget.extract.Extractor) | [`str`](https://docs.python.org/3/builtins/stdtypes.html#str) | [`None`](https://docs.python.org/3/builtins/constants.html#None)) – An `Extractor` callable, a registered extractor
    name (`str`), or `None` to use the `"default"` chain.
* **Return type:**
  [`ExtractionResult`](citeget.extract.md#citeget.extract.ExtractionResult)
* **Returns:**
  [`ExtractionResult`](#citeget.ExtractionResult) with parsed references and metadata.
* **Raises:**
  * [**AIExtractionRequested**](citeget.extract.md#citeget.extract.AIExtractionRequested) – If the `"ai"` extractor is selected.
...
* **Return type:**
  [`Reference`](citeget.acquire_references.md#citeget.acquire_references.Reference)
...
* **Parameters:**
  * **resolver** ([`UrlResolver`](citeget.resolve.md#citeget.resolve.UrlResolver) | [`str`](https://docs.python.org/3/builtins/stdtypes.html#str)) – A `UrlResolver` callable or registered name.
  * **downloader** ([`Downloader`](citeget.resolve.md#citeget.resolve.Downloader) | [`str`](https://docs.python.org/3/builtins/stdtypes.html#str) | [`None`](https://docs.python.org/3/builtins/constants.html#None)) – A `Downloader` callable or registered name.
...
* **Parameters:**
  ...
  * **strategy** ([`AcquisitionStrategy`](citeget.resolve.md#citeget.resolve.AcquisitionStrategy) | [`str`](https://docs.python.org/3/builtins/stdtypes.html#str) | [`None`](https://docs.python.org/3/builtins/constants.html#None)) – An `AcquisitionStrategy` callable, a registered
...
* **Parameters:**
  ...
  * **authors** ([`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str)]) – The author(s) wanted, in any of the orderings
    [`citeget.names`](citeget.names.md#module-citeget.names) understands. None skips author scoring.
  ...
  * **weights** ([`ScoreWeights`](citeget.rank.md#citeget.rank.ScoreWeights)) – Per-signal weights.
  * **size_bounds** ([`SizeBounds`](citeget.rank.md#citeget.rank.SizeBounds)) – What counts as a plausible file size.
...
* **Return type:**
  [`ScoredResult`](citeget.rank.md#citeget.rank.ScoredResult)
...
* **Parameters:**
  ...
  * **expected_bytes** ([`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`int`](https://docs.python.org/3/builtins/functions.html#int)]) – Size the search result advertised, for the truncation
    check. None skips it.
  * **policy** ([`ValidationPolicy`](citeget.validate.md#citeget.validate.ValidationPolicy)) – Which checks to apply. See `DEFAULT_POLICY` and
    `BOOK_POLICY`.
* **Return type:**
  [`ValidationResult`](citeget.validate.md#citeget.validate.ValidationResult)
...
* **Parameters:**
  ...
  * **policy** ([`ValidationPolicy`](citeget.validate.md#citeget.validate.ValidationPolicy)) – Which checks to apply.
* **Return type:**
  [`ValidationResult`](citeget.validate.md#citeget.validate.ValidationResult)
...
| [`acquire_references`](citeget.acquire_references.md#module-citeget.acquire_references)   | Tools for acquiring academic references as PDFs.                               |
|---------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
| [`article_pub`](citeget.article_pub.md#module-citeget.article_pub)                 | Article publication toolkit — journal profiling, checking, and formatting.     |
| [`cli`](citeget.cli.md#module-citeget.cli)                                 | CLI entry points for citeget.                                                  |
| [`core`](citeget.core.md#module-citeget.core)                               | Core search and download logic for libgen (libgen.vg-family mirrors).          |
| [`extract`](citeget.extract.md#module-citeget.extract)                         | Composable reference extraction from documents.                                |
| [`names`](citeget.names.md#module-citeget.names)                             | Author-name parsing for libgen metadata.                                       |
| [`rank`](citeget.rank.md#module-citeget.rank)                               | Rank libgen search results against a requested title and author.               |
| [`resolve`](citeget.resolve.md#module-citeget.resolve)                         | Composable download and URL-resolution for academic references.                |
| [`validate`](citeget.validate.md#module-citeget.validate)                       | Validate that a downloaded file is actually the book or paper it claims to be. |
